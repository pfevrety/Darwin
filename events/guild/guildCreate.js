    ...
    async run(guild) {
        ...
        if (textChats) {
            const embed = new Discord.MessageEmbed()
                ...
                .addField(
                    '\u200b',
                    '**[Invite](https://invite.darwin-bot.xyz) | ' +
                    '[Support Server](https://darwin-bot.xyz/support) | ' +
                    '[Dashboard](https://darwin-bot.xyz/dashboard)**'
                );
        ...
        const welcomeEmbed = new Discord.MessageEmbed()
            ...
            .setTitle('New Server')
            .setThumbnail(`https://darwin-bot.xyz/logo`)
            .setDescription(`Pogy was added to a new Server!`)
            .addField(`Server Name`, `\`${guild.name}\``, true)
            .addField(`Server ID`, `\`${guild.id}\``, true)
            .setFooter(`${this.client.guilds.cache.size} guilds `, 'https://darwin-bot.xyz/logo.png');

        welcomeClient.send({
            username: 'Darwin',
            avatarURL: 'https://darwin-bot.xyz/logo.png',
            embeds: [welcomeEmbed],
        })
